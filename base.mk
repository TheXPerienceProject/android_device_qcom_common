...
#PRODUCT_COPY_FILES := \
    ...
    frameworks/native/data/etc/android.hardware.sens-or.proximity.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.sensor.proximity.xml \
